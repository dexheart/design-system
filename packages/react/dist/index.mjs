...
function Toast() {
  const showToast = () => toast("Toast Example", {
  ...
  return /* @__PURE__ */ jsxs4(Box, { children: [
    /* @__PURE__ */ jsx5(Button, { onClick: showToast, children: /* @__PURE__ */ jsx5(Text, { size: "sm", children: "Click Here" }) }),
    /* @__PURE__ */ jsx5(
      ToastContainer,
      {
        toastStyle: {
...
function Tooltip(_a) {
  ...
  return /* @__PURE__ */ jsx6(
    Box,
    {
      ...
      children: /* @__PURE__ */ jsx6(TooltipMui, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsx6(
        Text,
        {
          size: "sm",
          style: {
